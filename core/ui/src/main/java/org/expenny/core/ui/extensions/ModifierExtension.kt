...
private fun Modifier.drawScrollbar(
    ...
    LaunchedEffect(scrolled, alpha) {
        scrolled.collectLatest {
            ...
            alpha.animateTo(0f, animationSpec = BarAnimationSpec)
        }
    }
...
private val BarColor: Color @Composable get() = MaterialTheme.colorScheme.outlineVariant
private val BarAnimationSpec = tween<Float>(durationMillis = ViewConfiguration.getScrollBarFadeDuration())