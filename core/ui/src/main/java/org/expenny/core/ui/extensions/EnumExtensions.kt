...
val ProfileActionType.color: Color
    @Composable get() = when (this) {
        ProfileActionType.CreateProfile -> MaterialTheme.colorScheme.onSurface
        ProfileActionType.SwitchProfile -> MaterialTheme.colorScheme.onSurface
        ProfileActionType.DeleteProfileData -> MaterialTheme.colorScheme.error
        ProfileActionType.DeleteProfile -> MaterialTheme.colorScheme.error
    }
